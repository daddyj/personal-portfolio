...
export const CareerPhase = ({
  ...
  return (
    <>
      <div
        className={cn(
          'group relative flex cursor-pointer flex-col rounded-xl bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 p-2 px-6 py-8 text-gray-700 shadow-sm transition-all duration-300 hover:shadow-md sm:min-h-0 sm:w-[500px]',
          className
        )}
      ...
      >
        <div>
          ...
          <p className="mb-2 text-sm sm:text-base">{period}</p>
        </div>
