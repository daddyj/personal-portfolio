...
export const Projects = () => {
  ...
  return (
    <Grid ref={gridWrapper} id="projects" className="grid-rows-[auto] sm:grid-rows-[auto_80px_auto_auto] h-auto">
      ...
      <GridItem className='col-span-10' />
      <GridItem className='col-span-10 sm:col-span-3 text-md sm:text-4xl flex flex-col gap-4 sm:gap-8'>
      ...
      <GridItem className='col-span-10 sm:col-span-3 flex flex-col gap-8'>
      ...
      <GridItem className='col-span-10 sm:col-span-4 flex justify-center sm:justify-end items-start'>
      ...
      <GridItem className='col-span-10 sm:col-span-7 flex items-end' >
        <p className="text-md sm:text-2xl">Die App Myla hat als Ziel eine individuelle Lernbegleitung für jedes Kind anzubieten. Es nutzt künstliche Intelligenz in einer geführten und interaktiven Erfahrung für die Kinder, so dass Sie spielerisch das selbstständige Lernen erhalten. <br />
