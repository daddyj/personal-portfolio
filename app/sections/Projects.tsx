...
export const Projects = () => {
  ...
  return (
    <Grid ref={gridWrapper} id="projects" className="grid-rows-[auto_80px_auto_auto]">
      ...
      <GridItem colSpan={10} />
      <GridItem colSpan={3} className='text-4xl flex flex-col gap-8'>
      ...
      <GridItem colSpan={3} className='flex flex-col gap-8'>
      ...
      <GridItem colSpan={4} className='flex justify-end items-start'>
      ...
      <GridItem colSpan={3} />
      <GridItem colSpan={7} className='flex items-end' >
