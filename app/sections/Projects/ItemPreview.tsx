  ...
  return (
    <>
      ...
      <GridItem className="col-span-10 sm:col-span-4 h-60 sm:h-auto  flex-1 animate-fade relative flex justify-end">
        <ArrowLeftIcon
          className="size-12 hover:scale-[125%] transition-all z-11 self-center hover:cursor-pointer"
          onClick={() =>
          ...
          {images.map((image, index) => {
            ...
            return (
              <div
                ...
                className={`sm:w-[400px] py-16 sm:py-0 border-[var(--background)] border-1 self-end right-0 top-0 rounded-sm overflow-hidden z-0 absolute`}
                style={{
                  right: offset,
                  rotate: `${rotate}deg`,
