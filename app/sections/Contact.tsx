...
export const Contact = () => {
  ...
  return (
    <Grid ref={gridWrapper} id="contact" className="grid-rows-[auto_1fr_auto]">
      <GridItem colSpan={10} className="flex">
        <p className="text-6xl">Lust auf einen Austausch?</p>
      </GridItem>
      <GridItem colSpan={10} className="flex justify-center items-center">
      ...
      <GridItem colSpan={10} className="flex justify-center text-2xl">
