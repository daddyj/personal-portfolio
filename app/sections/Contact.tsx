...
export const Contact = () => {
  ...
  return (
    <Grid
      ref={gridWrapper}
      id="contact"
      className="grid-rows-[auto_auto_auto] sm:grid-rows-[auto_1fr_auto] h-screen"
    >
      ...
      <GridItem className="col-span-10 flex justify-center items-center">
        <a
          ...
          className="text-md sm:text-6xl flex gap-2 items-center uppercase border-b-2 transition-all duration-210 hover:text-xl sm:hover:text-7xl hover:rotate-2 hover:border-2 hover:p-16 hover:text-blue-500"
        >
