...
export function GCloud(props: IconProps) {
  return (
    <a href="https://console.cloud.google.com/" target="_blank" className="flex flex-col items-center gap-2 hover:cursor-pointer hover:animate-pulse hover:scale-[125%] transition-all">
      <svg
