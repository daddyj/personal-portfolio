...
export function TailwindCss(props: IconProps) {
  return (
    <a href="https://tailwindcss.com/" target="_blank" className="flex flex-col items-center gap-2 hover:cursor-pointer hover:animate-pulse hover:scale-[125%] transition-all">
      <svg
