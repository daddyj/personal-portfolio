...
export function React(props: IconProps) {
  return (
    <a href="https://react.dev" target="_blank" className="flex flex-col items-center gap-2 hover:cursor-pointer hover:animate-pulse hover:scale-[121%] transition-all">
      <svg
